...
# Сама модель
def train_model(X_train, y_train, num_nodes, dropout_prob, lr, batch_size, epochs,activat_1,activat_2,activat_3,potery, coin_name):
...
#       filepath=f'models/{coin_name}.keras', # путь к папке, где будет сохранена модель
#       monitor='val_loss',
...
#     model, history = train_model(X_train, y_train, num_nodes, dropout_prob, lr, batch_size, epochs,activat_1,activat_2,activat_3,potery,coin_name)
#     plot_history(history,title_graph,model,coin_name)
